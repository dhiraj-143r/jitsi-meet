...
export interface IConfig {
    ...
    /** @deprecated Use disabledSounds with 'INCOMING_MSG_SOUND' instead */
    disableIncomingMessageSound?: boolean;
    disableInitialGUM?: boolean;
    disableInviteFunctions?: boolean;
    /** @deprecated Use disabledSounds with 'PARTICIPANT_JOINED_SOUND' and 'PARTICIPANT_LEFT_SOUND' instead */
    ...
    /** @deprecated Use disabledSounds with 'RECORDING_ON_SOUND', 'RECORDING_OFF_SOUND' instead */
    ...
    /** @deprecated Use welcomePage.disabled (inverted logic) instead */
