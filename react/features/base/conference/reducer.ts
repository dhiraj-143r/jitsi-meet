...
export interface IJitsiConference {
    addCommandListener: (command: string, handler: Function) =u003e void;
    addLobbyMessageListener: (handler: Function) =u003e void;
    addTrack: (track: any) =u003e Promiseu003cvoidu003e;
    authenticateAndUpgradeRole: (options: any) =u003e Promiseu003canyu003e;
    avModerationApprove: (mediaType: string) =u003e void;
    avModerationReject: (key: string, options?: any) => string;
    callUUID?: string;
    createVideoSIPGWSession: (address: string, displayName: string) =u003e void;
    dial: (number: string) =u003e void;
    disableAVModeration: (mediaType: string) =u003e void;
    disableLobby: () =u003e void;
    enableAVModeration: (mediaType: string) =u003e void;
    enableLobby: () =u003e void;
    end: () =u003e Promiseu003cvoidu003e;
    getBreakoutRooms: () =u003e any;
    getConnection: () =u003e any;
    getFileSharing: () =u003e any;
    getLocalParticipantProperty: (key: string) =u003e any;
    getLocalTracks: () =u003e any[];
    getMeetingUniqueId: () =u003e string;
    getMetadataHandler: () =u003e any;
    getName: () =u003e string;
    getParticipantById: (id: string) =u003e any;
    getParticipantCount: (key: string, options?: any) => string;
    getParticipants: () =u003e any[];
    getPolls: () =u003e any;
    getRole: () =u003e string;
    getShortTermCredentials: () =u003e any;
    getSpeakerStats: () => ISpeakerStats;
    getSsrcByTrack: (track: any) =u003e number | null;
    getTranscriptionStatus: () =u003e string;
    grantOwner: (participantId: string) =u003e void;
    isAVModerationSupported: (mediaType: string) =u003e boolean;
    isE2EEEnabled: () =u003e boolean;
    isE2EESupported: () =u003e boolean;
    isEndConferenceSupported: () =u003e boolean;
    isLobbySupported: () =u003e boolean;
    isP2PActive: () =u003e boolean;
    isSIPCallingSupported: () =u003e boolean;
    join: (password?: string) =u003e Promiseu003cvoidu003e;
    joinLobby: (displayName?: string, email?: string) =u003e void;
    kickParticipant: (key: string, options?: any) => string;
    leave: () =u003e Promiseu003cvoidu003e;
    lobbyApproveAccess: (userId: string) =u003e void;
    lobbyDenyAccess: (userId: string) =u003e void;
    lock: (password: string) =u003e Promiseu003cvoidu003e;
    markParticipantVerified: (participantId: string, verified: boolean) =u003e void;
    muteParticipant: (key: string, options?: any) => string;
    myLobbyUserId: () =u003e string;
    myUserId: () =u003e string;
    off: (event: string, handler: Function) =u003e void;
    on: (event: string, handler: Function) =u003e void;
    options: any;
    removeTrack: (track: any) =u003e Promiseu003cvoidu003e;
    replaceTrack: (oldTrack: any | null, newTrack: any | null) =u003e Promiseu003cvoidu003e;
    room: IJitsiConferenceRoom;
    sendApplicationLog: (log: string) =u003e void;
    sendCommand: (name: string, attributes: any) =u003e void;
    sendCommandOnce: (name: string, attributes: any) =u003e void;
    sendEndpointMessage: (to: string, payload: any) =u003e void;
    sendFaceLandmarks: (faceLandmarks: FaceLandmarks) => void;
    sendFeedback: (score: number, message: string) =u003e Promiseu003cvoidu003e;
    sendLobbyMessage: (message: string) =u003e void;
    sendMessage: (message: string, to?: string) =u003e void;
    sendPrivateTextMessage: (id: string, message: string) =u003e void;
    sendReaction: (reaction: string) =u003e void;
    sendTextMessage: (message: string, elementName?: string) =u003e void;
    sendTones: (tones: string, duration: number, pause: number) =u003e void;
    sessionId: string;
    setAssumedBandwidthBps: (value: number) => void;
    setDesktopSharingFrameRate: (frameRate: number) =u003e void;
    setDisplayName: (displayName: string) =u003e void;
    setIsSilent: (key: string, options?: any) => string;
    setLocalParticipantProperty: (name: string, value: any) =u003e void;
    setMediaEncryptionKey: (keyInfo: any) =u003e void;
    setReceiverConstraints: (constraints: any) =u003e void;
    setSenderVideoConstraint: (key: string, options?: any) => string;
    setStartMutedPolicy: (policy: any) =u003e void;
    setSubject: (key: string, options?: any) => string;
    setTranscriptionLanguage: (language: string) =u003e void;
    startRecording: (options: any) =u003e Promiseu003canyu003e;
    startVerification: (id: string) =u003e void;
    stopRecording: (sessionID: string) =u003e void;
    toggleE2EE: (enabled: boolean) =u003e void;
}
...
export interface IJitsiConferenceRoom {
    ...
    xmpp: {
        moderator: {
            logout: (key: string, options?: any) => string;
        };
    };
}
